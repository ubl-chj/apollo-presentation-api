...
class AnnotationQueryFormComponent extends React.Component {
  ...
  renderAnnotations() {
    ...
    if (renderQueryInfo) {
      if (annotation) {
        return <Annotation manifestId={manifestId} canvasId={canvasId} annotationPageId={annotationPageId} annotationId={annotationId}/>
      }
    }
  }
    ...
    if (canvasId && manifestId && annotationPageId && annotationId) {
      return (
        <div>
          ...
          <textarea
            cols="100" rows="3"
            value={annotationPageId}
            name={annotationPageId}
