...
import {ManifestQueryForm} from './components/ManifestQueryForm'
import {CanvasQueryForm} from './components/CanvasQueryForm'
import {AnnotationPageQueryForm} from './components/AnnotationPageQueryForm'
import {AnnotationQueryForm} from './components/AnnotationQueryForm'
  ...
  <div>
    ...
    <ul>
      ...
      <li>
        ...
        <p><span className="fTNNmo">GET</span>  /canvas?manifestId={'{'}<span style={{color: 'green'}}>manifestURI</span>{'}'}&canvasId={'{'}<span style={{color: 'green'}}>canvasId</span>{'}'}</p>
      </li>
      <li>
        <Link title='Validate Annotation Page' to='/annotationPage'>Validate Annotation Page</Link>
        <p><span className="fTNNmo">GET</span>  /annotationPage?manifestId={'{'}<span style={{color: 'green'}}>manifestURI</span>{'}'}&canvasId={'{'}<span style={{color: 'green'}}>canvasId</span>{'}'}&annotationPageId={'{'}<span style={{color: 'green'}}>annotationPageId</span>{'}'}</p>
      </li>
      <li>
        <Link title='Validate Annotation' to='/annotation'>Validate Annotation</Link>
        <p><span className="fTNNmo">GET</span>  /annotation?manifestId={'{'}<span style={{color: 'green'}}>manifestURI</span>{'}'}&canvasId={'{'}<span style={{color: 'green'}}>canvasId</span>{'}'}&annotationPageId={'{'}<span style={{color: 'green'}}>annotationPageId</span>{'}'}&annotationId={'{'}<span style={{color: 'green'}}>annotationId</span>{'}'}</p>
      </li>
    </ul>
  </div>
)
